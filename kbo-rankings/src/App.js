  ...
  useEffect(() => {
    ...
    const fetchTeamData = async () => {
      try {
        ...
        const scheduleRes = await fetch(`https://phi-graham-fees-moisture.trycloudflare.com/api/schedule/weekly?date=${formattedDate}&leId=1`);
        ...
        const rankingRes = await fetch(`https://phi-graham-fees-moisture.trycloudflare.com/api/rankings`);
